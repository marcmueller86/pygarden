...
class SensorFetcher(object):
    ...
    def __init__(self, database_name):
        ...
        """
        self.conn = sqlite3.connect("/home/pi/workspace/pygarden/output/%s.db" % database_name)
    ...
    def load_sensor_config(self):
        ...
        """
        with open('/home/pi/workspace/pygarden/config/sensor_config.json') as json_file:
